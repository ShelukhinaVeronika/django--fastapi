    ...
    def execute(self, category_id: int, category_data: CategoryUpdate) -> Category:
        ...
        updated_category = Category(
            ...
            slug=(
                ...
                else existing_category.slug
            ),
            is_published=(
                category_data.is_published
                if category_data.is_published is not None
                else existing_category.is_published
            ),
